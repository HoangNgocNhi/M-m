#include "game.h"
const char* TITLE = "The first game";
...
SDL_Window* initSDL(int SCREEN_WIDTH, int SCREEN_HEIGHT)
{
    ...
    //full screen
    //window = SDL_CreateWindow(TITLE, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_FULLSCREEN_DESKTOP);
